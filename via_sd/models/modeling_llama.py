...
# transformers>=4.43 移除了这两个类, 统一到 LlamaRotaryEmbedding 中
try:
...
class LlamaAttention(_LlamaAttention):
    ...
    def _init_rope(self):
        # transformers>=4.43: LlamaRotaryEmbedding 统一处理所有 scaling 类型,
        # 不再需要 LlamaLinearScalingRotaryEmbedding / LlamaDynamicNTKScalingRotaryEmbedding
        if LlamaLinearScalingRotaryEmbedding is None:
            # 新版 transformers: 直接用统一的 LlamaRotaryEmbedding
